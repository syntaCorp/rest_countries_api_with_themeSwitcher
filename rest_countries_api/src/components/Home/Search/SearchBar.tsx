...
function SearchBar({handleSearchTerm, searchTerm}: {handleSearchTerm: ChangeEventHandler, searchTerm: any }): React.ReactElement {
        ...
        <React.Fragment>
            <div className="search__pane">
                <div className="search__textbox">
                    ...
                    value={searchTerm} onChange={(event) => handleSearchTerm(event)}></input>
                </div>
